layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color) {
		...
		style += '.yueqian-this,.yueqian-text{color:' + color + '!important}';
		style += '.yueqian-back{background-color:'+ color +'!important}';
		...
		style += '.yueqian-admin .user a:hover{color:'+color+'!important}'
		style += '.yueqian-admin .user .layui-this a:hover{color:white!important}'
		style += '.yueqian-notice .layui-this{color:'+color+'!important}'
