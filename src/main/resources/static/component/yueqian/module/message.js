layui.define(['table', 'jquery', 'element'], function(exports) {
	...
	message.prototype.render = function(opt) {
		...
		setTimeout(function(){
			...
			$(opt.elem+" li").click(function(e){
				$(this).siblings().removeClass('yueqian-this');
				$(this).addClass('yueqian-this');
			})
		},300);
	...
	function createHtml(option) {
		...
		var notice = '<li class="layui-nav-item" lay-unselect="">' +
			...
			'<div class="layui-nav-child layui-tab yueqian-notice" style="margin-top: 0px;;left: -200px;">';
		...
		$.each(option.data, function(i, item) {
			...
			if (index === 0) {
				noticeTitle += '<li class="layui-this yueqian-this">' + item.title + '</li>';
			...
			$.each(item.children, function(i, note) {
				noticeContent += '<div class="yueqian-notice-item" notice-form="' + note.senderName + '" notice-context="' + note.content +
