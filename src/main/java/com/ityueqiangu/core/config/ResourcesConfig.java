...
public class ResourcesConfig implements WebMvcConfigurer {
    ...
    /*需要排除的请求*/
    private static List<String> EXCLUDE_PATH = Arrays.asList("/", "/login", "/register", "/erro","/profile/**", "/captcha/generate", "/login.html", "/index.html", "/admin/**", "/component/**", "/favicon.ico", "/yueqian.config.yml");
