...
import com.ityueqiangu.common.exception.user.UserPasswordNotMatchException;
import com.ityueqiangu.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class PasswordService
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(new PasswordService().encryptPassword("hdfj", "admin123", "222222"));
    }
}
