    ...
    <div class="layui-card-body">
        <form class="layui-form" action="" id="LAY_Form">
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="classeName" id="classeName" autocomplete="off" placeholder="请输入班主任名称" class="layui-input"  lay-verify="required">
                </div>
                <label class="layui-form-label layui-required" style="padding-left: 25px;">班主任名称</label>
                <div class="layui-input-inline">
                    <input type="text" name="classeTeacherName" id="classeTeacherName" autocomplete="off" placeholder="请输入班主任名称" class="layui-input" readonly  lay-verify="required">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
    ...
    layui.use(['element', 'table', 'form', 'jquery', 'layer', 'layerCustom','common'], function () {
        ...
        form.on("submit(search)", function (data) {
            ...
            var params ={
                ...
                classeTeacherName:$("#classeTeacherName").val(),
        ...
        $("#classeName").on('click',function () {
            layerCustom.open("班级选择",BaseUrl + 'assess/classeSelect', "700px", "550px",function () {
