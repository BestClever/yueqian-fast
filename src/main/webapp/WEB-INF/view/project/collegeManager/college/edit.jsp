                ...
                <div class="main-container">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="collegeName"  autocomplete="off" placeholder="请输入登录名称" class="layui-input"  lay-verify="required|collegeName" disabled>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea  placeholder="请输入学院简介" class="layui-textarea"></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    layui.use(['form', 'jquery', 'upload', 'element', 'layer', 'laydate', 'common', 'layerCustom'], function () {
        ...
        form.on('submit(add)', function (data) {
            var url = BaseUrl + 'college/update';
            //保存接口
