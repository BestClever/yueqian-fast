            ...
            <div class="main-container">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="parentName" id="parentName" autocomplete="off" placeholder="请输入上级部门名称" value="主目录" class="layui-input layui-disabled" lay-verify="required" readonly>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="permissionName" autocomplete="off" placeholder="请输入菜单名称" class="layui-input" lay-verify="required">
                    </div>
                </div>
    ...
    layui.use(['form', 'jquery', 'dtree', 'element', 'layer', 'laydate', 'common', 'layerCustom'], function () {
        ...
        form.verify({
            permissionName: function (value) {
                var url = BaseUrl + 'sysPermission/existPermissionNameName';
                var param = {
        ...
        form.on('submit(add)', function (data) {
            var url = BaseUrl + 'sysPermission/save';
            //保存接口
