...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            ...
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="iconfont layui-icon-ali-shousuo hideMenu"></a>
            <!-- 顶部右侧菜单 -->
            <ul class="layui-nav top_menu">
                ...
                <a href="javascript:;"><cite class="adminName"><span>${activerUser.userName} </span></cite></a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${baseurl}/static/images/avatar.jpg" class="userAvatar"></a>
            <p>你好！<span>${activerUser.userName}</span>, 欢迎登录</p>
        </div>

        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${baseurl}/main"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" class="refresh refreshThis"><i class="layui-icon">&#xe669;</i>
                            刷新当前</a></dd>
                        <dd><a href="javascript:;" class="closePageOther"><i class="iconfont layui-icon-ali-block"></i> 关闭其他</a>
                        </dd>
                        <dd><a href="javascript:;" class="closePageAll"><i class="iconfont layui-icon-ali-guanbi1"></i> 关闭全部</a></dd>
                    </dl>
                </li>
            </ul>
